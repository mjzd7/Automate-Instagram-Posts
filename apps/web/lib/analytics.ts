...
import { fetchAccountOverview, type AccountOverview } from "core/src/instagram/insights";
...
export async function getAccountAnalytics(
  ...
  try {
    ...
    return await fetchAccountOverview(accessToken, account.igUserId, fetchImpl);
  } finally {
    close();
  }
}
